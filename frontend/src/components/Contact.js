        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
          ...
          <div className="flex gap-4">
            <a 
              ...
              className="p-3 bg-gray-200 dark:bg-gray-800 text-black dark:text-white hover:text-blue-600 dark:hover:text-blue-400 rounded-lg shadow-md hover:shadow-lg transition-all"
            >
